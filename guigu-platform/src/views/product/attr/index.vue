    ...
    <div>
        ...
        <el-card style="margin: 10px 0px;">
            <div class="showtable" v-if="scene == 0">
                <el-button @click="addAttr" :disabled="categoryStore.c3Id ? false : true" type="primary" size="default"
            ...
            <div class="editCard" v-else>
                ...
                <el-button @click="addAttrValue" type="primary" size="default" icon="Plus" :disabled="attrParams.attrName?false:true">添加属性值</el-button>
                ...
                <el-table border style="margin: 10px 0px;" :data="attrParams.attrValueList">
                    ...
                    <el-table-column label="属性值名称">
                        ...
                        <template #="{ row, $index }">
                            ...
                            <el-input  v-model="row.valueName" placeholder="请输入文本对象" v-if="row.flag" @blur="toLook(row,$index)" :ref="(vc:any)=> inputArr[$index]=vc"></el-input>
