<template>
    <div>
        ...
        <el-card class="box-card">
            <el-button type="primary" icon="Plus" @click="addTrademark">添加图标</el-button>
            <!-- 表格组件：用于展示已有得平台数据 -->
            ...
            <!-- 分页器组件
                   ...
                   layout:可以设置分页器六个子组件布局调整
                    @current-change 页码更新的事件
                    @size-change 下拉菜单页码大小更新的事件
            -->
...
// // 分页器改变每一页展示多少条数据的函数
// 因为这个事件回传了每一页展示多少条数据v-model:page-size="limit" 这里其实没有必要用这个val：number
...
const confirm =async ()=>{
    // 对于整个表单进行校验，如果校验通过返回true，否则返回false，是一个promise
